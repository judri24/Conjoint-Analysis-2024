...
library(readxl)
sim_profiles <- read_excel("/Users/judithrichter/Desktop/Bachelorarbeit/Daten/Hochzuladende Dateien/Simulation_CBC.xlsx", sheet = "Chosen profiles for simulation")
#View(preference)
str(sim_profiles)
...
library(readxl)
sim_profiles <- read_excel("/Users/judithrichter/Desktop/Bachelorarbeit/Daten/Hochzuladende Dateien/Simulation_CBC.xlsx", sheet = "Used profiles in CBC")
predict_mnl_pref <- predict(mnl_pref, newdata = sim_profiles, obsID = "obsID")

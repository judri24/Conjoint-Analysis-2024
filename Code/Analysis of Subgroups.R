...
library(readxl)
x <- read_excel("../data/Data_CBC.xlsx", sheet = "CBC_ Choices_02")
View(x)
...
library(readxl)
data_clusters <- read_excel("../data/Cluster analysis.xlsx")
data_clusters
...
library(readxl)
socio <- read_excel("../data/Sociodemographics.xlsx", "Sociodemogr_for clustering")
socio
...
library(readxl)
RBC_Cluster <- read_excel("../data/Data_RBC.xlsx", sheet = "RBC_Cluster")
RBC_Cluster
...
library(readxl)
CBC_Cluster <- read_excel("../data/Data_CBC.xlsx", sheet = "Cluster_not edited")
CBC_Cluster
...
library(readxl)
cluster <- read_excel("../data/Data_RBC.xlsx", sheet = "RBC_Cluster")
cluster

clusterreg <- read_excel("../data/Data_RBC.xlsx", sheet = "RBC_Regression analysis_Cluster")
clusterreg
...
ggplot(cluster_table_RBC_melt, aes(x = Levels, y = Value, fill = Cluster)) + 
  ...
  scale_fill_manual(values = c("Cluster_RBC.1" = "darkgrey", "Cluster_RBC.2" = "lightgrey"),
                    labels = c("Cluster 1", "Cluster 2"))

# CBC with clusters from RBC
library(readxl)
x <- read_excel("../data/Data_CBC.xlsx", sheet = "CBC_Cluster")
#View(x)
